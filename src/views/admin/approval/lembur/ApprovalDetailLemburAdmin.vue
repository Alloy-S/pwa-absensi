  ...
  <BasePage>
      ...
      <div class="space-y-6">
          <div class="flex items-center justify-between">
              <div>
                  <h1 class="text-3xl font-semibold text-slate-800">Detail Approval Lembur</h1>
                  <p v-if="lemburDetail" class="text-sm text-gray-500">Tinjau pengajuan lembur untuk {{ lemburDetail.user.fullname }}</p>
              </div>
...
const handleAction = async (action: 'approve' | 'reject') => {
  ...
  try {
      ...
      router.push('/admin/approval/lembur');
  } catch (error: any) {
