<template>
    <BasePage>
      <div class="space-y-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-semibold text-slate-800">Approval Absensi Borongan</h1>
  ...
  // Fungsi Approval
  const approveAll = () => {
    alert('Absensi borongan telah disetujui.')
    // TODO: Panggil API approval absensi borongan
  }
  
  const rejectAll = () => {
    alert('Absensi borongan telah ditolak.')
    // TODO: Panggil API penolakan absensi borongan
  }
  </script>
