      ...
      <div class="space-y-6">
          <div class="flex items-center justify-between">
              <div>
                  ...
                  <p v-if="absensiDetail" class="text-sm text-gray-500">Tinjau riwayat absensi borongan yang dibuat oleh {{ absensiDetail.user.fullname }}</p>
              </div>
          ...
          <div v-else-if="absensiDetail" class="space-y-4">
              ...
              <div class="bg-white p-4 rounded-lg shadow-md">
                  ...
                  <div class="space-y-3 text-sm">
                      ...
                      <DetailItem icon="fa-solid fa-money-bill-wave" label="Total Biaya" :value="formatCurrency(absensiDetail.total)" />
                  </div>
              </div>
