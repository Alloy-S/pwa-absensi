    ...
    <div class="space-y-3">
      ...
      <div class="flex space-x-3">
        <div class="flex-[7] space-y-3">
          <form @submit.prevent="submitJadwalKerja">
            ...
            <div class="p-3 bg-white rounded-md shadow-md">
              ...
              <div v-if="jadwalKerja.is_same_hour" class="mb-6 flex space-x-2">
                <div class="w-1/2">
                  <label class="block mb-2 text-sm font-medium text-gray-900">Jam Masuk<span
                      class="text-red-600">*</span></label>
                  <input type="time" v-model="globalTimeIn"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                <div class="w-1/2">
                  <label class="block mb-2 text-sm font-medium text-gray-900">Jam Pulang<span
                      class="text-red-600">*</span></label>
              ...
              <div v-else class="space-y-4 mb-6">
                <div v-for="day in selectedDays" :key="day" class="flex space-x-2">
                  <div class="w-1/2">
                    <label class="block text-sm font-medium">{{ getDayLabel(day) }} - Jam Masuk<span
                        class="text-red-600">*</span></label>
                    <input type="time" v-model="dailyTimes[day].in"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                  </div>
                  <div class="w-1/2">
                    <label class="block text-sm font-medium">{{ getDayLabel(day) }} - Jam Pulang<span
                        class="text-red-600">*</span></label>
              ...
              <!-- Toleransi -->
              <div class="mb-6">
                <label for="toler-in" class="block mb-2 text-sm font-medium text-gray-900">Toleransi Masuk (menit)<span
                    class="text-red-600">*</span></label>
...
const submitJadwalKerja = async () => {
  ...
  try {
    ...
    const response = await addjadwal(jadwalKerja.value);
