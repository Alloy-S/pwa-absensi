<template>
    <BasePageNoNav>
        <TopHeader title="Approval Reimburse" :show-back-button="true" />
            ...
            <div v-else-if="reimburseDetail" class="space-y-4">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <DataTable :value="reimburseDetail.reimburse.detail_reimburse" responsiveLayout="scroll">
                        ...
                        <Column field="jumlah" header="Jml" bodyClass="text-center"></Column>
                        <Column field="harga" header="Harga" bodyClass="text-right">
