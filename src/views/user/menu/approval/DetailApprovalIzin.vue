<template>
    <BasePageNoNav>
        <TopHeader title="Approval Izin" :show-back-button="true" />
        ...
        <div class="p-4">
            ...
            <div v-else-if="izinDetail" class="space-y-4">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="font-medium text-slate-600">Jenis Izin</p>
                                <p class="text-slate-800">{{ izinDetail.izin.jenis_izin.nama }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            
                            <div>
                                <p class="font-medium text-slate-600">Tanggal Mulai</p>
                                <p class="text-slate-800">{{ formatDate(izinDetail.izin.tgl_izin_start) }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            
                            <div>
                                <p class="font-medium text-slate-600">Tanggal Selesai</p>
                                <p class="text-slate-800">{{ formatDate(izinDetail.izin.tgl_izin_end) }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                ...
                <div v-if="izinDetail.status.toLowerCase().includes('menunggu')"
