            ...
            <div class="p-4 space-y-4">
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    ...
                    <div v-else-if="isFaceRegistered" class="flex flex-col items-center justify-center text-green-600">
                        <div class="relative w-24 h-24">
                            ...
                            <i class="fa-solid fa-check-circle absolute bottom-0 right-0 text-3xl bg-white rounded-full"></i>
                        </div>
                    ...
                    <div v-else class="flex flex-col items-center justify-center text-red-600">
                        <div class="relative w-24 h-24">
                            ...
                            <i class="fa-solid fa-times-circle absolute bottom-0 right-0 text-3xl bg-white rounded-full"></i>
                        </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    ...
                    <div v-if="!capturedImage && !isCompressing">
                        <button @click="openCamera" class="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 font-semibold flex items-center justify-center space-x-2">
                    ...
                    <div v-if="capturedImage && !isCompressing" class="space-y-4">
                        ...
                        <div class="flex space-x-3">
                            <button @click="retakeImage" class="w-1/2 bg-gray-200 text-gray-800 py-3 rounded-lg hover:bg-gray-300 font-semibold">
                                Ambil Ulang
                            </button>
                            <button @click="registerFace" class="w-1/2 bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 font-semibold">
                                Daftarkan Wajah
                            </button>
                        </div>
                    </div>
